...
// Rest Assured
	...
	// Restassured by default support Gerkin methods
...
// Query Parameters and Path Parameters
	// https://reqres.in/api/users?page=1&id=5
		// Domain: https://reqres.in
		// Path: /api/users
		// Query: page=1 and id=5

// Serealization vs deserialization
	// Serealization, deserialization is a concept, RestAssured internally manages Serealization and deserialization
	// Serealization
...
// Oauth2.0
	...
	// Flow [https://aaronparecki.com/oauth-2-simplified/] [https://www.youtube.com/watch?v=CPbvxxslDTU]
		...
		// The user comes to BookMyShow page and wish to login with Google Credentials -> The login link is prenented to the user
